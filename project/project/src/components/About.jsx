  ...
  const experience = [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Resolved escalated hardware/software issues, improving customer satisfaction scores by 15%"
      ]
    }
  ]
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
            <div>
              ...
              Passionate Full-Stack Developer and coffee aficionado, blending creativity and technology to craft robust digital experiences. Just like the perfect cup of coffee, I strive for balance—between frontend elegance and backend efficiency, between innovation and functionality. Whether it's brewing a strong espresso or developing seamless APIs, precision and excellence are my priorities.
              </p>
              <div className="mb-8">
          ...
          <div className="mt-12">
            <h3 className="text-xl font-bold mb-6 text-coffee-800">Professional Experience</h3>
            <div className="space-y-8">
              {experience.map((exp, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: index * 0.2 }}
                  className="bg-coffee-50 p-6 rounded-lg"
                >
